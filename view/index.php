    ...
    <section>
        <div class="container-fluid fondo">
            <div class="container">
                ...
                <div class="col-md-4">
                    <br>
                    <img src="../img/logo1.jpg" class="img-circle imagen-logo" alt="Cinque Terre" width="200">
                    <p class="contenido-logo">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut sed massa vestibulum, sollicitudin augue vel, finibus mi. Nullam malesuada hendrerit lectus, malesuada laoreet justo efficitur egestas. Morbi arcu massa, venenatis non felis posuere, imperdiet lobortis justo. Curabitur lacus massa, dapibus quis commodo vitae</p>
